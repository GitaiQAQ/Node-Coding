(function() {
  ...
  Historys = (function(superClass) {
    ...
    function Historys() {
      this.historyUsingGET = bind(this.historyUsingGET, this);
    ...
    Historys.prototype.historyUsingGET = function(user, project, commits, params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
      ...
      this.debug("Historys::historyUsingGET()");
