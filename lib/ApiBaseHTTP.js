...
(function() {
  var ApiBase, _, cache, debug, fileCache, fs, querystring, request, slumber,
  ...
  module.exports.ApiBaseHTTP = (function(superClass) {
    ...
    ApiBaseHTTP.prototype.get = function(path, query, fn) {
      ...
      debug(path);
      return request.get(this.options.url + "/api/" + path).use(this.prefix).query(query).end(function(err, res) {
        console.log(err, res);
        if (fn) {
          console.log(fn);
          return fn(res);
