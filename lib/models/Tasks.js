...
(function() {
  ...
  Tasks = (function(superClass) {
    ...
    Tasks.prototype.update4client = function(user, project, id, params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
      ...
      this.debug("Tasks::update4client()");
    ...
    Tasks.prototype.deleteComment = function(user, project, id, commentId, params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
      ...
      this.debug("Tasks::deleteComment()");
    ...
    Tasks.prototype.updateContent = function(user, project, id, params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
      ...
      this.debug("Tasks::updateContent()");
    ...
    Tasks.prototype.updateDeadline = function(user, project, id, params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
      ...
      this.debug("Tasks::updateDeadline()");
    ...
    Tasks.prototype.updateOwner = function(user, project, id, params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
    ...
    Tasks.prototype.updatePriority = function(user, project, id, params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
      ...
      this.debug("Tasks::updatePriority()");
    ...
    Tasks.prototype.updateStatus = function(user, project, id, params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
