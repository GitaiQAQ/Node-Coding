...
(function() {
  ...
  Branchs = (function(superClass) {
    ...
    Branchs.prototype["default"] = function(user, project, params, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/git/branch/default", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Branchs.prototype.listBranches = function(user, project, params, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/git/branches", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Branchs.prototype.create = function(user, project, params, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/git/branches/create", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Branchs.prototype.del = function(user, project, params, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/git/branches/delete", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Branchs.prototype.addMember = function(user, project, params, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/git/branches/protected_branch/add_member", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Branchs.prototype.protectedBranch = function(user, project, params, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/git/branches/protected_branch/disable", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Branchs.prototype.protectedBranch = function(user, project, params, fn) {
      ...
      this.debug("Branchs::protectedBranch()");
      return this.post("/api/user/" + user + "/project/" + project + "/git/branches/protected_branch/enable", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Branchs.prototype.members = function(user, project, params, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/git/branches/protected_branch/members", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Branchs.prototype.deleteMember = function(user, project, params, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/git/branches/protected_branch/remove_member", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
