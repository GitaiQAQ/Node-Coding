...
(function() {
  ...
  PullRequests = (function(superClass) {
    ...
    PullRequests.prototype.create = function(user, project, params, fn) {
      ...
      return this.get("user/" + user + "/project/" + project + "/git/pull/create", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    PullRequests.prototype.get = function(user, project, iid, params, fn) {
      ...
      return this.get("user/" + user + "/project/" + project + "/git/pull/" + iid, params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    PullRequests.prototype.cancle = function(user, project, iid, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/git/pull/" + iid + "/cancel", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    PullRequests.prototype.comments = function(user, project, iid, fn) {
      ...
      return this.get("user/" + user + "/project/" + project + "/git/pull/" + iid + "/comments", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    PullRequests.prototype.commits = function(user, project, iid, fn) {
      ...
      return this.get("user/" + user + "/project/" + project + "/git/pull/" + iid + "/commits", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    PullRequests.prototype.merge = function(user, project, iid, params, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/git/pull/" + iid + "/merge", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    PullRequests.prototype.refuse = function(user, project, iid, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/git/pull/" + iid + "/refuse", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    PullRequests.prototype.list = function(user, project, status, params, fn) {
      ...
      return this.get("user/" + user + "/project/" + project + "/git/pulls/" + status, params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
