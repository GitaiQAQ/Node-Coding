...
(function() {
  ...
  Depots = (function(superClass) {
    ...
    Depots.prototype.get = function(user, project, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/git", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Depots.prototype.fork = function(user, project, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/git/fork", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Depots.prototype.forkList = function(user, project, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/git/forks", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Depots.prototype.createWebhook = function(user, project, params, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/git/hook", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Depots.prototype.getWebhook = function(user, project, id, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/git/hook/" + id, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Depots.prototype.updateWebhook = function(user, project, id, params, fn) {
      ...
      return this.put("/api/user/" + user + "/project/" + project + "/git/hook/" + id, params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Depots.prototype.deleteWebhook = function(user, project, id, fn) {
      ...
      return this["delete"]("/api/user/" + user + "/project/" + project + "/git/hook/" + id, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Depots.prototype.list = function(user, project, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/git/hooks", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Depots.prototype.importRepo = function(user, project, params, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/git/import", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Depots.prototype.importRepo = function(user, project, params, fn) {
      ...
      this.debug("Depots::importRepo()");
      return this.post("/api/user/" + user + "/project/" + project + "/git/import", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Depots.prototype.initDepot = function(user, project, params, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/git/init", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
