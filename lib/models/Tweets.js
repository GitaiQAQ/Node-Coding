...
(function() {
  ...
  Tweets = (function(superClass) {
    ...
    Tweets.prototype.bestUser = function(fn) {
      ...
      return this.get("social/tweet/best_user", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Tweets.prototype.comment = function(id, fn) {
      ...
      return this.get("social/tweet/comment/" + id, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Tweets.prototype.image = function(fn) {
      ...
      return this.post("social/tweet/insert_image", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Tweets.prototype.detail = function(user, tweet_id, params, fn) {
      ...
      return this.get("social/tweet/" + user + "/" + tweet_id, params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Tweets.prototype.comment = function(id, params, fn) {
      ...
      this.debug("Tweets::comment()");
      return this.post("social/tweet/" + id + "/comment", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Tweets.prototype.comment = function(id, comment_id, fn) {
      ...
      this.debug("Tweets::comment()");
      return this["delete"]("social/tweet/" + id + "/comment/" + comment_id, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Tweets.prototype.comment = function(id, params, fn) {
      ...
      this.debug("Tweets::comment()");
      return this.get("social/tweet/" + id + "/comments", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Tweets.prototype.del = function(tweet_id, fn) {
      ...
      return this["delete"]("social/tweet/" + tweet_id, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Tweets.prototype.like = function(tweet_id, fn) {
      ...
      return this.post("social/tweet/" + tweet_id + "/like", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Tweets.prototype.likeTweetList = function(tweet_id, params, fn) {
      ...
      return this.get("social/tweet/" + tweet_id + "/tweetlike", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Tweets.prototype.unlike = function(tweet_id, fn) {
      ...
      return this.post("social/tweet/" + tweet_id + "/unlike", function(data) {
        if (fn) {
          return fn(data);
        }
      });
