...
(function() {
  ...
  Tweets = (function(superClass) {
    ...
    Tweets.prototype.delete_comment = function(id, comment_id, params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
      ...
      this.debug("Tweets::delete_comment()");
    ...
    Tweets.prototype.deleteTweet = function(tweet_id, params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
