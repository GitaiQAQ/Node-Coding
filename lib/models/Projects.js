...
(function() {
  ...
  Projects = (function(superClass) {
    ...
    Projects.prototype.pinProject = function(params, fn) {
      ...
      this.debug("Projects::pinProject()");
      return this.post("account/projects/pin", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.pinProject = function(params, fn) {
      ...
      this.debug("Projects::pinProject()");
      return this["delete"]("account/projects/pin", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.recommendedList = function(fn) {
      ...
      return this.get("projects/recommended", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.queryByName = function(user, project, fn) {
      ...
      return this.get("user/" + user + "/project/" + project, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.deleteProject = function(user, project, params, fn) {
      ...
      return this["delete"]("user/" + user + "/project/" + project, params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.setProjectIcon = function(user, project, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/project_icon", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.star = function(user, project, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/star", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.stared = function(user, project, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/stared", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.unstar = function(user, project, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/unstar", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.unwatch = function(user, project, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/unwatch", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.visitProject = function(user, project, fn) {
      ...
      return this.get("user/" + user + "/project/" + project + "/update_visit", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.watch = function(user, project, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/watch", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.watched = function(user, project, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/watched", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.watched = function(user, project, fn) {
      ...
      this.debug("Projects::watched()");
      return this.get("user/" + user + "/project/" + project + "/watchers", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.privateProjects = function(params, fn) {
      ...
      this.debug("Projects::privateProjects()");
      return this.post("user/projects/private", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.privateProjects = function(params, fn) {
      ...
      this.debug("Projects::privateProjects()");
      return this.put("user/projects/private", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.privateProjects = function(params, fn) {
      ...
      this.debug("Projects::privateProjects()");
      return this["delete"]("user/projects/private", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.privateProjects = function(params, fn) {
      ...
      this.debug("Projects::privateProjects()");
      return this.options("user/projects/private", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.privateProjects = function(params, fn) {
      ...
      this.debug("Projects::privateProjects()");
      return this.patch("user/projects/private", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.createProject = function(user, params, fn) {
      ...
      return this.post("user/" + user + "/project", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.publicProjects = function(user, params, fn) {
      ...
      this.debug("Projects::publicProjects()");
      return this.get("user/" + user + "/projects/public", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.publicProjects = function(user, params, fn) {
      ...
      this.debug("Projects::publicProjects()");
      return this.post("user/" + user + "/projects/public", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.publicProjects = function(user, params, fn) {
      ...
      this.debug("Projects::publicProjects()");
      return this.put("user/" + user + "/projects/public", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.publicProjects = function(user, params, fn) {
      ...
      this.debug("Projects::publicProjects()");
      return this["delete"]("user/" + user + "/projects/public", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.publicProjects = function(user, params, fn) {
      ...
      this.debug("Projects::publicProjects()");
      return this.options("user/" + user + "/projects/public", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.publicProjects = function(user, params, fn) {
      ...
      this.debug("Projects::publicProjects()");
      return this.patch("user/" + user + "/projects/public", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
