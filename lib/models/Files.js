...
(function() {
  ...
  Files = (function(superClass) {
    ...
    Files.prototype.checkExisted = function(user, project, dir, params, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/dir/" + dir + "/files/existed", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.uploadNewVersion = function(user, project, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/file/history/upload", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.view = function(user, project, params, fn) {
      ...
      return this["delete"]("/api/user/" + user + "/project/" + project + "/files", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.history = function(user, project, id, fn) {
      ...
      return this["delete"]("/api/user/" + user + "/project/" + project + "/files/histories/" + id, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.download = function(user, project, id, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/files/histories/" + id + "/download", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.upload = function(user, project, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/files/upload", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.download = function(user, project, fileId, fn) {
      ...
      this.debug("Files::download()");
      return this.get("/api/user/" + user + "/project/" + project + "/files/" + fileId + "/download", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.download = function(user, project, fileId, fn) {
      ...
      this.debug("Files::download()");
      return this.get("/api/user/" + user + "/project/" + project + "/files/" + fileId + "/download/url", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.edit = function(user, project, fileId, params, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/files/" + fileId + "/edit", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.view = function(user, project, fileId, params, fn) {
      ...
      this.debug("Files::view()");
      return this.get("/api/user/" + user + "/project/" + project + "/files/" + fileId + "/view", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.preview = function(user, project, fileId, params, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/files/" + fileId + "/view/image", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.updateFileRemark = function(user, project, file_id, history_id, params, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/files/" + file_id + "/histories/" + history_id + "/remark", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.create = function(user, project, folderId, params, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/files/" + folderId + "/files", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.history = function(user, project, id, params, fn) {
      ...
      this.debug("Files::history()");
      return this.get("/api/user/" + user + "/project/" + project + "/files/" + id + "/histories", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.mkdir = function(user, project, params, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/folder", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.mkdir = function(user, project, fn) {
      ...
      this.debug("Files::mkdir()");
      return this["delete"]("/api/user/" + user + "/project/" + project + "/folder", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.move = function(user, project, dirId, params, fn) {
      ...
      return this.put("/api/user/" + user + "/project/" + project + "/folder/" + dirId + "/move", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.renameFolder = function(user, project, dir, params, fn) {
      ...
      return this.put("/api/user/" + user + "/project/" + project + "/folder/" + dir, params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.files = function(user, project, dir, params, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/folder/" + dir + "/files", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.folders = function(user, project, params, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/folders", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.folders = function(user, project, params, fn) {
      ...
      this.debug("Files::folders()");
      return this.get("/api/user/" + user + "/project/" + project + "/folders/all", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Files.prototype.count = function(user, project, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/folders/file_count/all", function(data) {
        if (fn) {
          return fn(data);
        }
      });
