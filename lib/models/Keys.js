...
(function() {
  ...
  Keys = (function(superClass) {
    ...
    Keys.prototype.get = function(user, keyId, fn) {
      ...
      this.debug("Keys::get()");
      return this.get("/api/user/" + user + "/key/" + keyId, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Keys.prototype.key = function(user, keyId, fn) {
      ...
      this.debug("Keys::key()");
      return this["delete"]("/api/user/" + user + "/key/" + keyId, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Keys.prototype.list = function(user, params, fn) {
      ...
      return this.get("/api/user/" + user + "/keys", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Keys.prototype.create = function(user, params, fn) {
      ...
      return this.post("/api/user/" + user + "/keys", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Keys.prototype.webhook = function(user, project, id, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/git/bind_deploy_key/" + id, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Keys.prototype.webhook = function(user, project, params, fn) {
      ...
      this.debug("Keys::webhook()");
      return this.post("/api/user/" + user + "/project/" + project + "/git/deploy_key", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Keys.prototype.list = function(user, project, fn) {
      ...
      this.debug("Keys::list()");
      return this.get("/api/user/" + user + "/project/" + project + "/git/deploy_keys", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Keys.prototype.webhook = function(user, project, id, fn) {
      ...
      this.debug("Keys::webhook()");
      return this.post("/api/user/" + user + "/project/" + project + "/git/unbind_deploy_key/" + id, function(data) {
        if (fn) {
          return fn(data);
        }
      });
