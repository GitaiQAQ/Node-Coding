...
(function() {
  ...
  Users = (function(superClass) {
    ...
    Users.prototype.activate = function(params, fn) {
      ...
      return this.post("/api/account/activate", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.generateActivatePhoneCode = function(params, fn) {
      ...
      return this.post("/api/account/activate/generate_phone_code", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.activatePhone = function(params, fn) {
      ...
      return this.post("/api/account/activate/phone", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.avatar = function(fn) {
      ...
      return this.get("/api/account/avatar", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.avatar = function(params, fn) {
      ...
      this.debug("Users::avatar()");
      return this.post("/api/account/avatar", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.captcha = function(action, params, fn) {
      ...
      return this.get("/api/account/captcha/" + action, params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.changeNoticeSetting = function(params, fn) {
      ...
      return this.get("/api/account/change_notice_setting", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.checkEmail = function(params, fn) {
      ...
      return this.get("/api/account/check", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.checkPhone = function(params, fn) {
      ...
      return this.get("/api/account/check/phone", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.checkTwoFactorAuthCode = function(params, fn) {
      ...
      return this.post("/api/account/check_two_factor_auth_code", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.currentUser = function(fn) {
      ...
      return this.get("/api/account/current_user", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.email = function(fn) {
      ...
      return this.get("/api/account/email", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.changeNoticeSetting = function(fn) {
      ...
      this.debug("Users::changeNoticeSetting()");
      return this.get("/api/account/get_notice_settings", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.gravatar = function(fn) {
      ...
      return this.get("/api/account/gravatar", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.getUserByGlobalKey = function(user, fn) {
      ...
      return this.get("/api/account/key/" + user, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.login = function(params, fn) {
      ...
      return this.post("/api/account/login", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.generateLoginPhoneCode = function(params, fn) {
      ...
      return this.post("/api/account/login/generate_phone_code", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.loginByPhone = function(params, fn) {
      ...
      return this.post("/api/account/login/phone", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.logout = function(params, fn) {
      ...
      return this.post("/api/account/logout", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.getUserByName = function(name, fn) {
      ...
      return this.get("/api/account/name/" + name, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.register = function(params, fn) {
      ...
      return this.post("/api/account/register", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.generateRegisterPhoneCode = function(params, fn) {
      ...
      return this.post("/api/account/register/generate_phone_code", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.phoneRegister = function(params, fn) {
      ...
      return this.post("/api/account/register/phone", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.avatar = function(params, fn) {
      ...
      this.debug("Users::avatar()");
      return this.post("/api/account/update_info", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.updatePwd = function(params, fn) {
      ...
      return this.post("/api/account/update_pwd", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.avatar = function(params, fn) {
      ...
      this.debug("Users::avatar()");
      return this.post("/api/account/updateavatar", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.follow = function(params, fn) {
      ...
      return this.post("/api/social/follow", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.follower = function(params, fn) {
      ...
      return this.get("/api/social/followers", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.follower = function(user, params, fn) {
      ...
      this.debug("Users::follower()");
      return this.get("/api/social/followers/" + user, params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.friends = function(params, fn) {
      ...
      return this.get("/api/social/friends", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.friends = function(user, params, fn) {
      ...
      this.debug("Users::friends()");
      return this.get("/api/social/friends/" + user, params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.relationship = function(user, fn) {
      ...
      return this.get("/api/social/relationship/" + user, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.changeNoticeSetting = function(fn) {
      ...
      this.debug("Users::changeNoticeSetting()");
      return this.get("/api/social/relationships", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.changeNoticeSetting = function(params, fn) {
      ...
      this.debug("Users::changeNoticeSetting()");
      return this.get("/api/social/relationships/all", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.search = function(params, fn) {
      ...
      return this.get("/api/social/search", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.unfollow = function(params, fn) {
      ...
      return this.post("/api/social/unfollow", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Users.prototype.unreadCount = function(fn) {
      ...
      return this.get("/api/social/unread_count", function(data) {
        if (fn) {
          return fn(data);
        }
      });
