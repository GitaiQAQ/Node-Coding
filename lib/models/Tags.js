...
(function() {
  ...
  Tags = (function(superClass) {
    ...
    Tags.prototype.list = function(user, project, params, fn) {
      ...
      return this.get("/api/user/" + user + "/project/" + project + "/git/tags", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Tags.prototype.create = function(user, project, params, fn) {
      ...
      return this.post("/api/user/" + user + "/project/" + project + "/git/tags/create", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Tags.prototype.del = function(user, project, params, fn) {
      ...
      this.debug("Tags::del()");
      return this.post("/api/user/" + user + "/project/" + project + "/git/tags/delete", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
