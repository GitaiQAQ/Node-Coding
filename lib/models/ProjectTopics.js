...
(function() {
  ...
  ProjectTopics = (function(superClass) {
    ...
    ProjectTopics.prototype.list = function(user, project, params, fn) {
      ...
      return this.get("user/" + user + "/project/" + project + "/topics", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.create = function(user, project, params, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/topics", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.count = function(user, project, fn) {
      ...
      return this.get("user/" + user + "/project/" + project + "/topics/count", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.getProjectTopicByLabel = function(user, project, id, params, fn) {
      ...
      return this.get("user/" + user + "/project/" + project + "/topics/label/" + id, params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.count = function(user, project, fn) {
      ...
      this.debug("ProjectTopics::count()");
      return this.get("user/" + user + "/project/" + project + "/topics/labels/my", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.list = function(user, project, params, fn) {
      ...
      this.debug("ProjectTopics::list()");
      return this.get("user/" + user + "/project/" + project + "/topics/mine", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.watchedProjectTopicList = function(user, project, params, fn) {
      ...
      return this.get("user/" + user + "/project/" + project + "/topics/watching", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.detail = function(user, project, id, params, fn) {
      ...
      return this.get("user/" + user + "/project/" + project + "/topics/" + id, params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.update = function(user, project, id, params, fn) {
      ...
      return this.put("user/" + user + "/project/" + project + "/topics/" + id, params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.del = function(user, project, id, fn) {
      ...
      return this["delete"]("user/" + user + "/project/" + project + "/topics/" + id, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.comments = function(user, project, id, params, fn) {
      ...
      return this.get("user/" + user + "/project/" + project + "/topics/" + id + "/comments", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.addTopicLabel = function(user, project, id, labelId, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/topics/" + id + "/label/" + labelId, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.deleteTopicLabel = function(user, project, id, labelId, fn) {
      ...
      return this["delete"]("user/" + user + "/project/" + project + "/topics/" + id + "/label/" + labelId, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.operateTopicLabel = function(user, project, id, params, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/topics/" + id + "/labels", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.watch = function(user, project, id, fn) {
      ...
      return this.post("user/" + user + "/project/" + project + "/topics/" + id + "/watch", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectTopics.prototype.watchers = function(user, project, id, params, fn) {
      ...
      return this.get("user/" + user + "/project/" + project + "/topics/" + id + "/watchers", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
